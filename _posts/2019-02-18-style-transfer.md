...
12. Then at the end of my 2000 iterations, I displayed my content, and my target image side-by-side. You can see that the target image still looks a lot like a rowing boat?? In fact, I think I could have stylized this even more. However, we can see that the target image has some of the brushstroke texture from the Salvador Dali painting which was used as my style image.
    ```python
