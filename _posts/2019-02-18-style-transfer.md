...
In this documentation I will discuss the steps to take in implementing the style transfer algorithm. Style transfer allows you to apply the style of one image to another image of your choice. ((For example, here we have applied this wave to a pic of cat in order to produce the final picture...))
...
12. Then at the end of my 2000 iterations, I displayed my content and my target image side-by-side. You can see that the target image still looks a lot like a rowing boat?? In fact i think I could have stylized this even more. This target image also has some of the brushstroke texture from the Salvador painting that I used as a style image.
    ```python
