...
*(Fact about Transport Layer: the Transport Layer is defined as both connection-oriented and connectionless.)*
...
**Use of UDP**
However, when it comes to UDP, there is unreliable data transfer between sending and receiving process. Also, it does not provide reliability, flow control, congestion control, timing, throughput guarantee or security.
